...
class CallableAssertionTest {
  ...
  <<Test>>
  public function expectedExceptionWithMessageContaining(
    Assert $assert,
  ): void {
    $this->buildThrowingAssertion()
      ->willThrowMessageContaining(self::message);
    $this->buildThrowingAssertion()
      ->willThrowMessageContaining(self::subMessage);
  ...
  public function expectedExceptionClassWithMessage(Assert $assert): void {
    $this->buildThrowingAssertion()
      ->willThrowClassWithMessage(self::exceptionClass, self::message);
  ...
  <<Test>>
  public function expectedExceptionClassWithMessageContaining(
    Assert $assert,
  ): void {
    $this->buildThrowingAssertion()->willThrowClassWithMessageContaining(
      self::exceptionClass,
      self::message,
    );
    $this->buildThrowingAssertion()->willThrowClassWithMessageContaining(
  ...
  public function missingExceptionClassWithMessage(Assert $assert): void {
    $this->buildNonThrowingAssertion()
      ->willThrowClassWithMessage(self::class, self::message);
  ...
  <<Test>>
  public function missingExceptionClassWithMessageContaining(
    Assert $assert,
  ): void {
    $this->buildNonThrowingAssertion()
      ->willThrowClassWithMessageContaining(self::class, self::message);
  ...
  public function messageDoesNotContain(Assert $assert): void {
    $this->buildThrowingAssertion()
      ->willThrowMessageContaining(self::notSubMessage);
  ...
  public function wrongClassMessageDoesContain(Assert $assert): void {
    $this->buildThrowingAssertion()
      ->willThrowClassWithMessageContaining(self::class, self::message);
    $this->buildThrowingAssertion()
      ->willThrowClassWithMessageContaining(self::class, self::subMessage);
  ...
  public function rightClassWrongMessage(Assert $assert): void {
    $this->buildThrowingAssertion()
      ->willThrowClassWithMessage(self::exceptionClass, self::subMessage);
