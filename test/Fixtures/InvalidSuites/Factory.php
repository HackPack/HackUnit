...
final class DuplicateFactories {
  <<SuiteProvider>>
  public static function one(): this {
    return new static();
  }

  <<SuiteProvider>>
  public static function two(): this {
    return new static();
  }
}
...
final class FactoryParams {
  <<SuiteProvider>>
  public static function factory(int $required): this {
    return new static();
  }
}
...
abstract class AbstractFactory {
  ...
  public static function factory(): AbstractFactory {
    return new InvalidDerivedFactory();
  }
}
